(function (_, Kotlin, $module$kotlinx_coroutines_core) {
  ...
  Coroutine$doAction_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$widget = GWorld.CreateWidget(this.$this.actor.Widget, GWorld.GetPlayerController(0));
  ...
  FirstPerson.prototype.onFire = function () {
    ...
    var damageActor = tempHitResult.HitObjectHandle.Actor;
  ...
  Switch.prototype.BeginOverlap = function (other) {
    var tmp$;
    var actor = GetOwner(this);
    (tmp$ = actor.Lock) != null ? tmp$.DestroyActor() : null;
...
//# sourceMappingURL=kotlin-examples.js.map
