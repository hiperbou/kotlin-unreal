...
external open class NiagaraUserParameterBinding {
    open var Parameter: NiagaraVariable
    open fun clone(): NiagaraUserParameterBinding

    companion object {
        fun C(Other: UObject): NiagaraUserParameterBinding
        fun C(Other: Any): NiagaraUserParameterBinding
    }
}

external object ENDIExport_GPUAllocationMode {
    var FixedSize: String /* "FixedSize" */
    var PerParticle: String /* "PerParticle" */
    var ENDIExport_MAX: String /* "ENDIExport_MAX" */
}

external open class NiagaraDataInterfaceExport : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    open var CallbackHandlerParameter: NiagaraUserParameterBinding
    open var GPUAllocationMode: String /* "FixedSize" | "PerParticle" | "ENDIExport_MAX" */
    open var GPUAllocationFixedSize: Number
    open var GPUAllocationPerParticleSize: Number

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceExport
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceExport
        fun GetDefaultObject(): NiagaraDataInterfaceExport
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceExport
        fun C(Other: UObject): NiagaraDataInterfaceExport
        fun C(Other: Any): NiagaraDataInterfaceExport
    }
}

external open class NiagaraDataInterfaceGBuffer : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceGBuffer
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceGBuffer
        fun GetDefaultObject(): NiagaraDataInterfaceGBuffer
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceGBuffer
        fun C(Other: UObject): NiagaraDataInterfaceGBuffer
        fun C(Other: Any): NiagaraDataInterfaceGBuffer
    }
}

external open class NiagaraDataInterfaceRWBase : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    open var OutputShaderStages: Any
    open var IterationShaderStages: Any

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceRWBase
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceRWBase
        fun GetDefaultObject(): NiagaraDataInterfaceRWBase
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceRWBase
        fun C(Other: UObject): NiagaraDataInterfaceRWBase
        fun C(Other: Any): NiagaraDataInterfaceRWBase
    }
}

external open class NiagaraDataInterfaceGrid2D : NiagaraDataInterfaceRWBase {
    constructor()
    constructor(Outer: UObject)
    open var NumCellsX: Number
    open var NumCellsY: Number
    open var NumCellsMaxAxis: Number
    open var NumAttributes: Number
    open var SetGridFromMaxAxis: Boolean
    open var WorldBBoxSize: Vector2D

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceGrid2D
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceGrid2D
        fun GetDefaultObject(): NiagaraDataInterfaceGrid2D
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceGrid2D
        fun C(Other: UObject): NiagaraDataInterfaceGrid2D
        fun C(Other: Any): NiagaraDataInterfaceGrid2D
    }
}

external object ENiagaraGpuBufferFormat {
    var Float: String /* "Float" */
    var HalfFloat: String /* "HalfFloat" */
    var UnsignedNormalizedByte: String /* "UnsignedNormalizedByte" */
    var Max: String /* "Max" */
    var ENiagaraGpuBufferFormat_MAX: String /* "ENiagaraGpuBufferFormat_MAX" */
}
...
external open class NiagaraDataInterfaceGrid2DCollection : NiagaraDataInterfaceGrid2D {
    constructor()
    constructor(Outer: UObject)
    open var RenderTargetUserParameter: NiagaraUserParameterBinding
    open var OverrideBufferFormat: String /* "Float" | "HalfFloat" | "UnsignedNormalizedByte" | "Max" | "ENiagaraGpuBufferFormat_MAX" */
    open var bOverrideFormat: Boolean
    open var bPreviewGrid: Boolean
    open var PreviewAttribute: String
    open var ManagedRenderTargets: Any
    open fun GetTextureSize(Component: NiagaraComponent, SizeX: Number = definedExternally, SizeY: Number = definedExternally): `T$0`
    open fun GetRawTextureSize(Component: NiagaraComponent, SizeX: Number = definedExternally, SizeY: Number = definedExternally): `T$0`
    open fun FillTexture2D(Component: NiagaraComponent, Dest: TextureRenderTarget2D, AttributeIndex: Number): Boolean
    open fun FillRawTexture2D(Component: NiagaraComponent, Dest: TextureRenderTarget2D, TilesX: Number = definedExternally, TilesY: Number = definedExternally): `T$1`

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceGrid2DCollection
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceGrid2DCollection
        fun GetDefaultObject(): NiagaraDataInterfaceGrid2DCollection
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceGrid2DCollection
        fun C(Other: UObject): NiagaraDataInterfaceGrid2DCollection
        fun C(Other: Any): NiagaraDataInterfaceGrid2DCollection
    }
}

external open class NiagaraDataInterfaceGrid2DCollectionReader : NiagaraDataInterfaceGrid2D {
    constructor()
    constructor(Outer: UObject)
    open var EmitterName: String
    open var DIName: String

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceGrid2DCollectionReader
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceGrid2DCollectionReader
        fun GetDefaultObject(): NiagaraDataInterfaceGrid2DCollectionReader
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceGrid2DCollectionReader
        fun C(Other: UObject): NiagaraDataInterfaceGrid2DCollectionReader
        fun C(Other: Any): NiagaraDataInterfaceGrid2DCollectionReader
    }
}

external object ESetResolutionMethod {
    var Independent: String /* "Independent" */
    var MaxAxis: String /* "MaxAxis" */
    var CellSize: String /* "CellSize" */
    var ESetResolutionMethod_MAX: String /* "ESetResolutionMethod_MAX" */
}

external open class NiagaraDataInterfaceGrid3D : NiagaraDataInterfaceRWBase {
    constructor()
    constructor(Outer: UObject)
    open var NumCells: IntVector
    open var CellSize: Number
    open var NumCellsMaxAxis: Number
    open var SetResolutionMethod: String /* "Independent" | "MaxAxis" | "CellSize" | "ESetResolutionMethod_MAX" */
    open var WorldBBoxSize: Vector

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceGrid3D
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceGrid3D
        fun GetDefaultObject(): NiagaraDataInterfaceGrid3D
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceGrid3D
        fun C(Other: UObject): NiagaraDataInterfaceGrid3D
        fun C(Other: Any): NiagaraDataInterfaceGrid3D
    }
}
...
external open class NiagaraDataInterfaceGrid3DCollection : NiagaraDataInterfaceGrid3D {
    constructor()
    constructor(Outer: UObject)
    open var NumAttributes: Number
    open var RenderTargetUserParameter: NiagaraUserParameterBinding
    open var BufferFormat: String /* "Float" | "HalfFloat" | "UnsignedNormalizedByte" | "Max" | "ENiagaraGpuBufferFormat_MAX" */
    open fun GetTextureSize(Component: NiagaraComponent, SizeX: Number = definedExternally, SizeY: Number = definedExternally, SizeZ: Number = definedExternally): `T$2`
    open fun GetRawTextureSize(Component: NiagaraComponent, SizeX: Number = definedExternally, SizeY: Number = definedExternally, SizeZ: Number = definedExternally): `T$2`
    open fun FillVolumeTexture(Component: NiagaraComponent, Dest: VolumeTexture, AttributeIndex: Number): Boolean
    open fun FillRawVolumeTexture(Component: NiagaraComponent, Dest: VolumeTexture, TilesX: Number = definedExternally, TilesY: Number = definedExternally, TileZ: Number = definedExternally): `T$3`

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceGrid3DCollection
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceGrid3DCollection
        fun GetDefaultObject(): NiagaraDataInterfaceGrid3DCollection
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceGrid3DCollection
        fun C(Other: UObject): NiagaraDataInterfaceGrid3DCollection
        fun C(Other: Any): NiagaraDataInterfaceGrid3DCollection
    }
}

external open class NiagaraDataInterfaceLandscape : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    open var SourceLandscape: Actor

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceLandscape
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceLandscape
        fun GetDefaultObject(): NiagaraDataInterfaceLandscape
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceLandscape
        fun C(Other: UObject): NiagaraDataInterfaceLandscape
        fun C(Other: Any): NiagaraDataInterfaceLandscape
    }
}

external open class NiagaraDataInterfaceNeighborGrid3D : NiagaraDataInterfaceGrid3D {
    constructor()
    constructor(Outer: UObject)
    open var MaxNeighborsPerCell: Any

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceNeighborGrid3D
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceNeighborGrid3D
        fun GetDefaultObject(): NiagaraDataInterfaceNeighborGrid3D
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceNeighborGrid3D
        fun C(Other: UObject): NiagaraDataInterfaceNeighborGrid3D
        fun C(Other: Any): NiagaraDataInterfaceNeighborGrid3D
    }
}

external open class NiagaraDataInterfaceOcclusion : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceOcclusion
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceOcclusion
        fun GetDefaultObject(): NiagaraDataInterfaceOcclusion
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceOcclusion
        fun C(Other: UObject): NiagaraDataInterfaceOcclusion
        fun C(Other: Any): NiagaraDataInterfaceOcclusion
    }
}

external open class NiagaraDataInterfaceParticleRead : NiagaraDataInterfaceRWBase {
    constructor()
    constructor(Outer: UObject)
    open var EmitterName: String

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceParticleRead
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceParticleRead
        fun GetDefaultObject(): NiagaraDataInterfaceParticleRead
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceParticleRead
        fun C(Other: UObject): NiagaraDataInterfaceParticleRead
        fun C(Other: Any): NiagaraDataInterfaceParticleRead
    }
}

external open class NiagaraDataInterfacePlatformSet : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    open var Platforms: NiagaraPlatformSet

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfacePlatformSet
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfacePlatformSet
        fun GetDefaultObject(): NiagaraDataInterfacePlatformSet
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfacePlatformSet
        fun C(Other: UObject): NiagaraDataInterfacePlatformSet
        fun C(Other: Any): NiagaraDataInterfacePlatformSet
    }
}

external open class NiagaraDataInterfaceRenderTarget2D : NiagaraDataInterfaceRWBase {
    constructor()
    constructor(Outer: UObject)
    open var Size: IntPoint
    open var OverrideRenderTargetFormat: String /* "RTF_R8" | "RTF_RG8" | "RTF_RGBA8" | "RTF_RGBA8_SRGB" | "RTF_R16f" | "RTF_RG16f" | "RTF_RGBA16f" | "RTF_R32f" | "RTF_RG32f" | "RTF_RGBA32f" | "RTF_RGB10A2" | "RTF_MAX" */
    open var bOverrideFormat: Boolean
    open var bPreviewRenderTarget: Boolean
    open var RenderTargetUserParameter: NiagaraUserParameterBinding
    open var ManagedRenderTargets: Any

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceRenderTarget2D
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceRenderTarget2D
        fun GetDefaultObject(): NiagaraDataInterfaceRenderTarget2D
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceRenderTarget2D
        fun C(Other: UObject): NiagaraDataInterfaceRenderTarget2D
        fun C(Other: Any): NiagaraDataInterfaceRenderTarget2D
    }
}

external open class NiagaraDataInterfaceRenderTarget2DArray : NiagaraDataInterfaceRWBase {
    constructor()
    constructor(Outer: UObject)
    open var Size: IntVector
    open var OverrideRenderTargetFormat: String /* "RTF_R8" | "RTF_RG8" | "RTF_RGBA8" | "RTF_RGBA8_SRGB" | "RTF_R16f" | "RTF_RG16f" | "RTF_RGBA16f" | "RTF_R32f" | "RTF_RG32f" | "RTF_RGBA32f" | "RTF_RGB10A2" | "RTF_MAX" */
    open var bOverrideFormat: Boolean
    open var bPreviewRenderTarget: Boolean
    open var RenderTargetUserParameter: NiagaraUserParameterBinding
    ...
    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceRenderTarget2DArray
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceRenderTarget2DArray
        fun GetDefaultObject(): NiagaraDataInterfaceRenderTarget2DArray
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceRenderTarget2DArray
        fun C(Other: UObject): NiagaraDataInterfaceRenderTarget2DArray
        fun C(Other: Any): NiagaraDataInterfaceRenderTarget2DArray
    }
}

external open class NiagaraDataInterfaceRenderTargetVolume : NiagaraDataInterfaceRWBase {
    constructor()
    constructor(Outer: UObject)
    open var Size: IntVector
    open var OverrideRenderTargetFormat: String /* "RTF_R8" | "RTF_RG8" | "RTF_RGBA8" | "RTF_RGBA8_SRGB" | "RTF_R16f" | "RTF_RG16f" | "RTF_RGBA16f" | "RTF_R32f" | "RTF_RG32f" | "RTF_RGBA32f" | "RTF_RGB10A2" | "RTF_MAX" */
    ...
    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceRenderTargetVolume
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceRenderTargetVolume
        fun GetDefaultObject(): NiagaraDataInterfaceRenderTargetVolume
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceRenderTargetVolume
        fun C(Other: UObject): NiagaraDataInterfaceRenderTargetVolume
        fun C(Other: Any): NiagaraDataInterfaceRenderTargetVolume
    }
}

external open class NiagaraDataInterfaceSimpleCounter : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceSimpleCounter
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceSimpleCounter
        fun GetDefaultObject(): NiagaraDataInterfaceSimpleCounter
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceSimpleCounter
        fun C(Other: UObject): NiagaraDataInterfaceSimpleCounter
        fun C(Other: Any): NiagaraDataInterfaceSimpleCounter
    }
}

external object ENDISkeletalMesh_SourceMode {
    var Default: String /* "Default" */
    var Source: String /* "Source" */
    var AttachParent: String /* "AttachParent" */
    var ENDISkeletalMesh_MAX: String /* "ENDISkeletalMesh_MAX" */
}

external object ENDISkeletalMesh_SkinningMode {
    var Invalid: String /* "Invalid" */
    var None: String /* "None" */
    var SkinOnTheFly: String /* "SkinOnTheFly" */
    var PreSkin: String /* "PreSkin" */
    var ENDISkeletalMesh_MAX: String /* "ENDISkeletalMesh_MAX" */
}

external open class NiagaraDataInterfaceSkeletalMesh : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    open var SourceMode: String /* "Default" | "Source" | "AttachParent" | "ENDISkeletalMesh_MAX" */
    open var PreviewMesh: SkeletalMesh
    open var Source: Actor
    open var MeshUserParameter: NiagaraUserParameterBinding
    open var SourceComponent: SkeletalMeshComponent
    open var SkinningMode: String /* "Invalid" | "None" | "SkinOnTheFly" | "PreSkin" | "ENDISkeletalMesh_MAX" */
    open var SamplingRegions: Array<String>
    open var WholeMeshLOD: Number
    open var FilteredBones: Array<String>
    open var FilteredSockets: Array<String>
    open var ExcludeBoneName: String
    open var bExcludeBone: Boolean
    open var bRequireCurrentFrameData: Boolean

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceSkeletalMesh
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceSkeletalMesh
        fun GetDefaultObject(): NiagaraDataInterfaceSkeletalMesh
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceSkeletalMesh
        fun C(Other: UObject): NiagaraDataInterfaceSkeletalMesh
        fun C(Other: Any): NiagaraDataInterfaceSkeletalMesh
    }
}

external open class NiagaraDataInterfaceSpline : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    open var Source: Actor

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceSpline
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceSpline
        fun GetDefaultObject(): NiagaraDataInterfaceSpline
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceSpline
        fun C(Other: UObject): NiagaraDataInterfaceSpline
        fun C(Other: Any): NiagaraDataInterfaceSpline
    }
}

external object ENDIStaticMesh_SourceMode {
    var Default: String /* "Default" */
    var Source: String /* "Source" */
    var AttachParent: String /* "AttachParent" */
    var DefaultMeshOnly: String /* "DefaultMeshOnly" */
    var ENDIStaticMesh_MAX: String /* "ENDIStaticMesh_MAX" */
}

external open class NDIStaticMeshSectionFilter {
    open var AllowedMaterialSlots: Array<Number>
    open fun clone(): NDIStaticMeshSectionFilter

    companion object {
        fun C(Other: UObject): NDIStaticMeshSectionFilter
        fun C(Other: Any): NDIStaticMeshSectionFilter
    }
}

external open class NiagaraDataInterfaceStaticMesh : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    open var SourceMode: String /* "Default" | "Source" | "AttachParent" | "DefaultMeshOnly" | "ENDIStaticMesh_MAX" */
    open var PreviewMesh: StaticMesh
    open var DefaultMesh: StaticMesh
    open var Source: Actor
    open var SourceComponent: StaticMeshComponent
    open var SectionFilter: NDIStaticMeshSectionFilter
    open var bUsePhysicsBodyVelocity: Boolean
    open var FilteredSockets: Array<String>

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceStaticMesh
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceStaticMesh
        fun GetDefaultObject(): NiagaraDataInterfaceStaticMesh
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceStaticMesh
        fun C(Other: UObject): NiagaraDataInterfaceStaticMesh
        fun C(Other: Any): NiagaraDataInterfaceStaticMesh
    }
}

external open class NiagaraDataInterfaceTexture : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    open var Texture: Texture

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceTexture
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceTexture
        fun GetDefaultObject(): NiagaraDataInterfaceTexture
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceTexture
        fun C(Other: UObject): NiagaraDataInterfaceTexture
        fun C(Other: Any): NiagaraDataInterfaceTexture
    }
}

external open class NiagaraDataInterfaceVector2DCurve : NiagaraDataInterfaceCurveBase {
    constructor()
    constructor(Outer: UObject)
    open var XCurve: RichCurve
    open var YCurve: RichCurve

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceVector2DCurve
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceVector2DCurve
        fun GetDefaultObject(): NiagaraDataInterfaceVector2DCurve
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceVector2DCurve
        fun C(Other: UObject): NiagaraDataInterfaceVector2DCurve
        fun C(Other: Any): NiagaraDataInterfaceVector2DCurve
    }
}

external open class NiagaraDataInterfaceVector4Curve : NiagaraDataInterfaceCurveBase {
    constructor()
    constructor(Outer: UObject)
    open var XCurve: RichCurve
    open var YCurve: RichCurve
    open var ZCurve: RichCurve
    open var WCurve: RichCurve

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceVector4Curve
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceVector4Curve
        fun GetDefaultObject(): NiagaraDataInterfaceVector4Curve
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceVector4Curve
        fun C(Other: UObject): NiagaraDataInterfaceVector4Curve
        fun C(Other: Any): NiagaraDataInterfaceVector4Curve
    }
}

external open class NiagaraDataInterfaceVectorCurve : NiagaraDataInterfaceCurveBase {
    constructor()
    constructor(Outer: UObject)
    open var XCurve: RichCurve
    open var YCurve: RichCurve
    ...
    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceVectorCurve
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceVectorCurve
        fun GetDefaultObject(): NiagaraDataInterfaceVectorCurve
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceVectorCurve
        fun C(Other: UObject): NiagaraDataInterfaceVectorCurve
        fun C(Other: Any): NiagaraDataInterfaceVectorCurve
    }
}

external open class NiagaraDataInterfaceVectorField : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    ...
    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceVectorField
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceVectorField
        fun GetDefaultObject(): NiagaraDataInterfaceVectorField
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceVectorField
        fun C(Other: UObject): NiagaraDataInterfaceVectorField
        fun C(Other: Any): NiagaraDataInterfaceVectorField
    }
}

external open class NiagaraDataInterfaceVolumeTexture : NiagaraDataInterface {
    constructor()
    constructor(Outer: UObject)
    open var Texture: VolumeTexture

    companion object {
        fun Load(ResourceName: String): NiagaraDataInterfaceVolumeTexture
        fun Find(Outer: UObject, ResourceName: String): NiagaraDataInterfaceVolumeTexture
        fun GetDefaultObject(): NiagaraDataInterfaceVolumeTexture
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraDataInterfaceVolumeTexture
        fun C(Other: UObject): NiagaraDataInterfaceVolumeTexture
        fun C(Other: Any): NiagaraDataInterfaceVolumeTexture
    }
}

external open class NiagaraSignificanceHandlerDistance : NiagaraSignificanceHandler {
    constructor()
    constructor(Outer: UObject)

    companion object {
        fun Load(ResourceName: String): NiagaraSignificanceHandlerDistance
        fun Find(Outer: UObject, ResourceName: String): NiagaraSignificanceHandlerDistance
        fun GetDefaultObject(): NiagaraSignificanceHandlerDistance
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraSignificanceHandlerDistance
        fun C(Other: UObject): NiagaraSignificanceHandlerDistance
        fun C(Other: Any): NiagaraSignificanceHandlerDistance
    }
}

external open class NiagaraSignificanceHandlerAge : NiagaraSignificanceHandler {
    constructor()
    constructor(Outer: UObject)

    companion object {
        fun Load(ResourceName: String): NiagaraSignificanceHandlerAge
        fun Find(Outer: UObject, ResourceName: String): NiagaraSignificanceHandlerAge
        fun GetDefaultObject(): NiagaraSignificanceHandlerAge
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraSignificanceHandlerAge
        fun C(Other: UObject): NiagaraSignificanceHandlerAge
        fun C(Other: Any): NiagaraSignificanceHandlerAge
    }
}

external open class NiagaraEventReceiverEmitterAction : UObject {
    constructor()
    constructor(Outer: UObject)

    companion object {
        fun Load(ResourceName: String): NiagaraEventReceiverEmitterAction
        fun Find(Outer: UObject, ResourceName: String): NiagaraEventReceiverEmitterAction
        fun GetDefaultObject(): NiagaraEventReceiverEmitterAction
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraEventReceiverEmitterAction
        fun C(Other: UObject): NiagaraEventReceiverEmitterAction
        fun C(Other: Any): NiagaraEventReceiverEmitterAction
    }
}

external open class NiagaraEventReceiverEmitterAction_SpawnParticles : NiagaraEventReceiverEmitterAction {
    constructor()
    constructor(Outer: UObject)
    open var NumParticles: Any

    companion object {
        fun Load(ResourceName: String): NiagaraEventReceiverEmitterAction_SpawnParticles
        fun Find(Outer: UObject, ResourceName: String): NiagaraEventReceiverEmitterAction_SpawnParticles
        fun GetDefaultObject(): NiagaraEventReceiverEmitterAction_SpawnParticles
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraEventReceiverEmitterAction_SpawnParticles
        fun C(Other: UObject): NiagaraEventReceiverEmitterAction_SpawnParticles
        fun C(Other: Any): NiagaraEventReceiverEmitterAction_SpawnParticles
    }
}

external open class NiagaraFunctionLibrary : BlueprintFunctionLibrary {
    constructor()
    constructor(Outer: UObject)

    companion object {
        fun Load(ResourceName: String): NiagaraFunctionLibrary
        fun Find(Outer: UObject, ResourceName: String): NiagaraFunctionLibrary
        fun GetDefaultObject(): NiagaraFunctionLibrary
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraFunctionLibrary
        ...
        fun C(Other: UObject): NiagaraFunctionLibrary
        fun C(Other: Any): NiagaraFunctionLibrary
    }
}

external open class NiagaraLightRendererProperties : NiagaraRendererProperties {
    constructor()
    constructor(Outer: UObject)
    open var bUseInverseSquaredFalloff: Boolean
    open var bAffectsTranslucency: Boolean
    open var RadiusScale: Number
    open var ColorAdd: Vector
    open var LightRenderingEnabledBinding: NiagaraVariableAttributeBinding
    open var LightExponentBinding: NiagaraVariableAttributeBinding
    open var PositionBinding: NiagaraVariableAttributeBinding
    open var ColorBinding: NiagaraVariableAttributeBinding
    open var RadiusBinding: NiagaraVariableAttributeBinding
    open var VolumetricScatteringBinding: NiagaraVariableAttributeBinding

    companion object {
        fun Load(ResourceName: String): NiagaraLightRendererProperties
        fun Find(Outer: UObject, ResourceName: String): NiagaraLightRendererProperties
        fun GetDefaultObject(): NiagaraLightRendererProperties
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraLightRendererProperties
        fun C(Other: UObject): NiagaraLightRendererProperties
        fun C(Other: Any): NiagaraLightRendererProperties
    }
}

external object ENiagaraSortMode {
    var None: String /* "None" */
    var ViewDepth: String /* "ViewDepth" */
    var ViewDistance: String /* "ViewDistance" */
    var CustomAscending: String /* "CustomAscending" */
    var CustomDecending: String /* "CustomDecending" */
    var ENiagaraSortMode_MAX: String /* "ENiagaraSortMode_MAX" */
}

external open class NiagaraMeshMaterialOverride {
    open var ExplicitMat: MaterialInterface
    open var UserParamBinding: NiagaraUserParameterBinding
    open fun clone(): NiagaraMeshMaterialOverride

    companion object {
        fun C(Other: UObject): NiagaraMeshMaterialOverride
        fun C(Other: Any): NiagaraMeshMaterialOverride
    }
}

external object ENiagaraMeshFacingMode {
    var Default: String /* "Default" */
    var Velocity: String /* "Velocity" */
    var CameraPosition: String /* "CameraPosition" */
    var CameraPlane: String /* "CameraPlane" */
    var ENiagaraMeshFacingMode_MAX: String /* "ENiagaraMeshFacingMode_MAX" */
}

external object ENiagaraMeshLockedAxisSpace {
    var Simulation: String /* "Simulation" */
    var World: String /* "World" */
    var Local: String /* "Local" */
    var ENiagaraMeshLockedAxisSpace_MAX: String /* "ENiagaraMeshLockedAxisSpace_MAX" */
}

external object ENiagaraMeshPivotOffsetSpace {
    var Mesh: String /* "Mesh" */
    var Simulation: String /* "Simulation" */
    var World: String /* "World" */
    var Local: String /* "Local" */
    var ENiagaraMeshPivotOffsetSpace_MAX: String /* "ENiagaraMeshPivotOffsetSpace_MAX" */
}

external open class NiagaraMeshRendererProperties : NiagaraRendererProperties {
    constructor()
    constructor(Outer: UObject)
    open var ParticleMesh: StaticMesh
    open var SortMode: String /* "None" | "ViewDepth" | "ViewDistance" | "CustomAscending" | "CustomDecending" | "ENiagaraSortMode_MAX" */
    open var bOverrideMaterials: Boolean
    open var bSortOnlyWhenTranslucent: Boolean
    open var OverrideMaterials: Array<NiagaraMeshMaterialOverride>
    open var SubImageSize: Vector2D
    open var bSubImageBlend: Boolean
    open var FacingMode: String /* "Default" | "Velocity" | "CameraPosition" | "CameraPlane" | "ENiagaraMeshFacingMode_MAX" */
    open var bLockedAxisEnable: Boolean
    open var LockedAxis: Vector
    open var LockedAxisSpace: String /* "Simulation" | "World" | "Local" | "ENiagaraMeshLockedAxisSpace_MAX" */
    open var PivotOffset: Vector
    open var PivotOffsetSpace: String /* "Mesh" | "Simulation" | "World" | "Local" | "ENiagaraMeshPivotOffsetSpace_MAX" */
    open var bEnableFrustumCulling: Boolean
    ...
    open var MeshOrientationBinding: NiagaraVariableAttributeBinding
    open var ScaleBinding: NiagaraVariableAttributeBinding
    ...
    companion object {
        fun Load(ResourceName: String): NiagaraMeshRendererProperties
        fun Find(Outer: UObject, ResourceName: String): NiagaraMeshRendererProperties
        fun GetDefaultObject(): NiagaraMeshRendererProperties
        fun CreateDefaultSubobject(Name: String, Transient: Boolean = definedExternally, Required: Boolean = definedExternally, Abstract: Boolean = definedExternally): NiagaraMeshRendererProperties
        fun C(Other: UObject): NiagaraMeshRendererProperties
        fun C(Other: Any): NiagaraMeshRendererProperties
    }
}
...
external open class NiagaraPreviewAxis : UObject {
    ...
    constructor(Outer: UObject)
    open fun Num(): Number
    open fun ApplyToPreview(PreviewComponent: NiagaraComponent, PreviewIndex: Number, bIsXAxis: Boolean, OutLabelText: String = definedExternally): `T$4`
...
external open class NiagaraPreviewGrid(InWorld: World, Location: Vector = definedExternally, Rotation: Rotator = definedExternally) : Actor {
    ...
    open fun GetPreviews(OutPreviews: Array<NiagaraComponent> = definedExternally): `T$5`
...
external open class NiagaraClipboardEditorScriptingUtilities : UObject {
    ...
    companion object {
        ...
        fun TrySetLocalValueAsInt(InInput: NiagaraClipboardFunctionInput, bOutSucceeded: Boolean = definedExternally, InValue: Number = definedExternally, bLooseTyping: Boolean = definedExternally): `T$6`
        fun TryGetLocalValueAsInt(InInput: NiagaraClipboardFunctionInput, bOutSucceeded: Boolean = definedExternally, OutValue: Number = definedExternally): `T$7`
        fun TryGetLocalValueAsFloat(InInput: NiagaraClipboardFunctionInput, bOutSucceeded: Boolean = definedExternally, OutValue: Number = definedExternally): `T$7`
        fun TryGetInputByName(InInputs: Array<NiagaraClipboardFunctionInput>, InInputName: String, bOutSucceeded: Boolean = definedExternally, OutInput: NiagaraClipboardFunctionInput = definedExternally): `T$8`
...
external open class MagicLeapPlanesFunctionLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun ReorderPlaneFlags(InPriority: Array<String /* "Vertical" | "Horizontal" | "Arbitrary" | "OrientToGravity" | "PreferInner" | "Ceiling" | "Floor" | "Wall" | "Polygons" | "EMagicLeapPlaneQueryFlags_MAX" */>, InFlagsToReorder: Array<String /* "Vertical" | "Horizontal" | "Arbitrary" | "OrientToGravity" | "PreferInner" | "Ceiling" | "Floor" | "Wall" | "Polygons" | "EMagicLeapPlaneQueryFlags_MAX" */>, OutReorderedFlags: Array<String /* "Vertical" | "Horizontal" | "Arbitrary" | "OrientToGravity" | "PreferInner" | "Ceiling" | "Floor" | "Wall" | "Polygons" | "EMagicLeapPlaneQueryFlags_MAX" */> = definedExternally): `T$9`
        fun RemovePersistentQuery(Handle: Guid): Boolean
        fun RemoveFlagsNotInQuery(InQueryFlags: Array<String /* "Vertical" | "Horizontal" | "Arbitrary" | "OrientToGravity" | "PreferInner" | "Ceiling" | "Floor" | "Wall" | "Polygons" | "EMagicLeapPlaneQueryFlags_MAX" */>, InResultFlags: Array<String /* "Vertical" | "Horizontal" | "Arbitrary" | "OrientToGravity" | "PreferInner" | "Ceiling" | "Floor" | "Wall" | "Polygons" | "EMagicLeapPlaneQueryFlags_MAX" */>, OutFlags: Array<String /* "Vertical" | "Horizontal" | "Arbitrary" | "OrientToGravity" | "PreferInner" | "Ceiling" | "Floor" | "Wall" | "Polygons" | "EMagicLeapPlaneQueryFlags_MAX" */> = definedExternally): `T$10`
...
external open class MagicLeapLightEstimationColorTemperatureState {
    ...
    open fun GetColorTemperatureState(): `T$11`
    ...
    companion object {
        ...
        fun GetColorTemperatureState(ColorTemperatureState: MagicLeapLightEstimationColorTemperatureState = definedExternally): `T$11`
    }
}
...
external open class MagicLeapLightEstimationAmbientGlobalState {
    ...
    open fun GetAmbientGlobalState(): `T$12`

    companion object {
        fun C(Other: UObject): MagicLeapLightEstimationAmbientGlobalState
        fun C(Other: Any): MagicLeapLightEstimationAmbientGlobalState
        fun GetAmbientGlobalState(GlobalAmbientState: MagicLeapLightEstimationAmbientGlobalState = definedExternally): `T$12`
    }
}
...
external open class MagicLeapARPinComponent : SceneComponent {
    ...
    open fun UnPin()
    open fun TryGetPinData(InPinDataClass: UnrealEngineClass, OutPinDataValid: Boolean = definedExternally): `T$13`
    ...
    open fun GetPinState(State: MagicLeapARPinState = definedExternally): `T$14`
    open fun GetPinnedPinID(PinId: Guid = definedExternally): `T$15`
...
external open class MagicLeapARPinQuery {
    ...
    open fun GetGlobalQueryFilter(): `T$16`
    open fun QueryARPins(Pins: Array<Guid> = definedExternally): `T$17`
    ...
    companion object {
        ...
        fun GetGlobalQueryFilter(CurrentGlobalFilter: MagicLeapARPinQuery = definedExternally): `T$16`
        fun QueryARPins(Query: MagicLeapARPinQuery, Pins: Array<Guid> = definedExternally): `T$18`
...
external open class MagicLeapARPinFunctionLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun QueryARPins(Query: MagicLeapARPinQuery, Pins: Array<Guid> = definedExternally): `T$19`
        fun ParseStringToARPinId(PinIdString: String, ARPinId: Guid = definedExternally): `T$20`
        fun IsTrackerValid(): Boolean
        fun GetNumAvailableARPins(Count: Number = definedExternally): `T$21`
        fun GetGlobalQueryFilter(CurrentGlobalFilter: MagicLeapARPinQuery = definedExternally): `T$16`
        fun GetContentBindingSaveGameUserIndex(): Number
        fun GetClosestARPin(SearchPoint: Vector, PinId: Guid = definedExternally): `T$22`
        fun GetAvailableARPins(NumRequested: Number, Pins: Array<Guid> = definedExternally): `T$23`
        fun GetARPinStateToString(State: MagicLeapARPinState): String
        fun GetARPinState(PinId: Guid, State: MagicLeapARPinState = definedExternally): `T$24`
        fun GetARPinPositionAndOrientation_TrackingSpace(PinId: Guid, Position: Vector = definedExternally, Orientation: Rotator = definedExternally, PinFoundInEnvironment: Boolean = definedExternally): `T$25`
        fun GetARPinPositionAndOrientation(PinId: Guid, Position: Vector = definedExternally, Orientation: Rotator = definedExternally, PinFoundInEnvironment: Boolean = definedExternally): `T$25`
...
external open class LuminARFrameFunctionLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun LuminARLineTrace(WorldContextObject: UObject, ScreenPosition: Vector2D, TraceChannels: Any, OutHitResults: Array<ARTraceResult> = definedExternally): `T$26`
...
external open class MagicLeapControllerFunctionLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun GetControllerMapping(ControllerIndex: Number, hand: String /* "Left" | "Right" | "AnyHand" | "Pad" | "ExternalCamera" | "Gun" | "Special_1" | "Special_2" | "Special_3" | "Special_4" | "Special_5" | "Special_6" | "Special_7" | "Special_8" | "Special_9" | "Special_10" | "Special_11" | "ControllerHand_Count" | "EControllerHand_MAX" */ = definedExternally): `T$27`
...
external open class EyeTrackerStereoGazeData {
    ...
    open fun GetStereoGazeData(): `T$28`

    companion object {
        fun C(Other: UObject): EyeTrackerStereoGazeData
        fun C(Other: Any): EyeTrackerStereoGazeData
        fun GetStereoGazeData(OutGazeData: EyeTrackerStereoGazeData = definedExternally): `T$28`
    }
}
...
external open class EyeTrackerGazeData {
    ...
    open fun GetGazeData(): `T$29`

    companion object {
        fun C(Other: UObject): EyeTrackerGazeData
        fun C(Other: Any): EyeTrackerGazeData
        fun GetGazeData(OutGazeData: EyeTrackerGazeData = definedExternally): `T$29`
    }
}
...
external open class MagicLeapEyeBlinkState {
    ...
    open fun GetEyeBlinkState(): `T$30`

    companion object {
        fun C(Other: UObject): MagicLeapEyeBlinkState
        fun C(Other: Any): MagicLeapEyeBlinkState
        fun GetEyeBlinkState(BlinkState: MagicLeapEyeBlinkState = definedExternally): `T$30`
    }
}
...
external open class LiveLinkSourceHandle {
    ...
    open fun GetMagicLeapHandTrackingLiveLinkSource(): `T$31`

    companion object {
        fun C(Other: UObject): LiveLinkSourceHandle
        fun C(Other: Any): LiveLinkSourceHandle
        fun GetMagicLeapHandTrackingLiveLinkSource(SourceHandle: LiveLinkSourceHandle = definedExternally): `T$31`
    }
}
...
external open class MagicLeapIdentity : UObject {
    constructor()
    constructor(Outer: UObject)
    open fun RequestAttributeValue(RequestedAttributeList: Array<String /* "GivenName" | "FamilyName" | "Email" | "Bio" | "PhoneNumber" | "Avatar2D" | "Avatar3D" | "Unknown" | "EMagicLeapIdentityKey_MAX" */>, RequestedAttributeValues: Array<MagicLeapIdentityAttribute> = definedExternally): `T$43`
    open fun GetAllAvailableAttributes(AvailableAttributes: Array<String /* "GivenName" | "FamilyName" | "Email" | "Bio" | "PhoneNumber" | "Avatar2D" | "Avatar3D" | "Unknown" | "EMagicLeapIdentityKey_MAX" */> = definedExternally): `T$44`
...
external open class MagicLeapSecureStorage : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun GetSecureSaveGame(Key: String, ObjectToRetrieve: SaveGame = definedExternally): `T$48`
        fun GetSecureRotator(Key: String, DataToRetrieve: Rotator = definedExternally): `T$49`
        fun GetSecureInt64(Key: String, DataToRetrieve: Any = definedExternally): `T$50`
        fun GetSecureInt(Key: String, DataToRetrieve: Number = definedExternally): `T$51`
        fun GetSecureFloat(Key: String, DataToRetrieve: Number = definedExternally): `T$51`
        fun GetSecureByte(Key: String, DataToRetrieve: Number = definedExternally): `T$51`
        fun GetSecureBool(Key: String, DataToRetrieve: Boolean = definedExternally): `T$52`
        fun GetSecureArray(Key: String, DataToRetrieve: Array<Number> = definedExternally): `T$53`
...
external open class JavascriptContext : UObject {
    ...
    open fun FindPathFile(TargetRootPath: String, TargetFileName: String, OutFiles: Array<String> = definedExternally): `T$54`
...
external open class JavascriptIsolate : UObject {
    ...
    open fun GetHeapStatistics(Statistics: JavascriptHeapStatistics = definedExternally): `T$55`
...
external open class JavascriptInternetAddr {
    ...
    open fun SetIp(ResolvedAddress: String = definedExternally, bValid: Boolean = definedExternally): `T$56`
    open fun SetPort(Port: Number = definedExternally): `T$57`

    companion object {
        fun C(Other: UObject): JavascriptInternetAddr
        fun C(Other: Any): JavascriptInternetAddr
        fun SetIp(Addr: JavascriptInternetAddr = definedExternally, ResolvedAddress: String = definedExternally, bValid: Boolean = definedExternally): `T$56`
        fun SetPort(Addr: JavascriptInternetAddr = definedExternally, Port: Number = definedExternally): `T$57`
...
external open class JavascriptSocket {
    ...
    open fun SendMemoryTo(ToAddr: JavascriptInternetAddr = definedExternally, NumBytes: Number = definedExternally, BytesSent: Number = definedExternally): `T$58`

    companion object {
        fun C(Other: UObject): JavascriptSocket
        fun C(Other: Any): JavascriptSocket
        fun SendMemoryTo(Socket: JavascriptSocket = definedExternally, ToAddr: JavascriptInternetAddr = definedExternally, NumBytes: Number = definedExternally, BytesSent: Number = definedExternally): `T$58`
...
external open class JavascriptLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun SendMemoryTo(Socket: JavascriptSocket = definedExternally, ToAddr: JavascriptInternetAddr = definedExternally, NumBytes: Number = definedExternally, BytesSent: Number = definedExternally): `T$58`
        fun SegmentIntersection2D(SegmentStartA: Vector, SegmentEndA: Vector, SegmentStartB: Vector, SegmentEndB: Vector, IntersectionPoint: Vector = definedExternally): `T$59`
        fun ResolveIp(HostName: String, OutIp: String = definedExternally): `T$60`
        ...
        fun ReadDirectory(UObject: UObject, Directory: String, OutItems: Array<DirectoryItem> = definedExternally): `T$61`
        fun NewStat(InStatName: String, InStatDesc: String, InGroupName: String, InGroupCategory: String, InGroupDesc: String, bDefaultEnable: Boolean, bShouldClearEveryFrame: Boolean, InStatType: String /* "Invalid" | "ST_None" | "ST_int64" | "ST_double" | "ST_FName" | "ST_Ptr" | "EJavascriptStatDataType_MAX" */, bCycleStat: Boolean, bSortByName: Boolean): JavascriptStat
        ...
        fun HandleSeamlessTravelPlayer(GameMode: GameModeBase, C: Controller = definedExternally): `T$62`
        ...
        fun GetObjectsWithOuter(Outer: UObject, Results: Array<UObject> = definedExternally, bIncludeNestedObjects: Boolean = definedExternally, ExclusionFlags: Number = definedExternally, ExclusionInternalFlags: Number = definedExternally): `T$63`
        fun GetObjectsOfClass(ClassToLookFor: UnrealEngineClass, Results: Array<UObject> = definedExternally, bIncludeDerivedClasses: Boolean = definedExternally, ExcludeFlags: Number = definedExternally, ExclusionInternalFlags: Number = definedExternally): `T$64`
        fun GetNodeId(UNode: JavascriptProfileNode): Number
        ...
        fun GetDerivedClasses(ClassToLookFor: UnrealEngineClass, Results: Array<UnrealEngineClass> = definedExternally, bRecursive: Boolean = definedExternally): `T$65`
        fun GetDeoptInfosCount(UNode: JavascriptProfileNode, index: Number): Number
        fun GetDeoptInfo_Stack(UNode: JavascriptProfileNode, index: Number): String
        fun GetDeoptInfo_Reason(UNode: JavascriptProfileNode, index: Number): String
        ...
        fun GetAllActorsOfClassAndTagsInCurrentLevel(WorldContextObject: UObject, ActorClass: UnrealEngineClass, Tags_Accept: Array<String>, Tags_Deny: Array<String>, OutActors: Array<Actor> = definedExternally): `T$66`
        fun GetAllActorsOfClassAndTags(WorldContextObject: UObject, ActorClass: UnrealEngineClass, Tags_Accept: Array<String>, Tags_Deny: Array<String>, OutActors: Array<Actor> = definedExternally): `T$67`
...
external open class JavascriptProcess : UObject {
    constructor()
    constructor(Outer: UObject)
    open fun WriteToPipe(Message: String, OutWritten: String = definedExternally): `T$68`
    open fun Wait()
    open fun Terminate(KillTree: Boolean)
    open fun ReadFromPipe(): String
    open fun ReadArrayFromPipe(Array: Array<Number> = definedExternally): `T$69`
    open fun IsRunning(): Boolean
    open fun GetReturnCode(ReturnCode: Number = definedExternally): `T$71`
    open fun Close()
    ...
    companion object {
        ...
        fun LaunchURL(URL: String, Parms: String, Error: String = definedExternally): `T$70`
...
external open class JavascriptAutomatedTestInstance {
    ...
    companion object {
        ...
        fun Destroy(Test: JavascriptAutomatedTestInstance = definedExternally): `T$72`
...
external open class JavascriptIntSpinBox : Widget {
    ...
    open fun GetValue(NewValue: Number)
...
external open class JavascriptTreeView : ListViewBase {
    ...
    open fun GetSelectedItems(OutItems: Array<UObject> = definedExternally): `T$73`
    open fun GetDoubleClickedItems(OutItems: Array<UObject> = definedExternally): `T$74`
...
external open class JavascriptTextLayout {
    ...
    open fun AddLine(Model: JavascriptTextModel = definedExternally, Runs: Array<JavascriptSlateTextRun> = definedExternally): `T$75`
    open fun ClearLines(): `T$75`
    ...
    companion object {
        ...
        fun AddLine(TextLayout: JavascriptTextLayout = definedExternally, Model: JavascriptTextModel = definedExternally, Runs: Array<JavascriptSlateTextRun> = definedExternally): `T$75`
        fun ClearLines(TextLayout: JavascriptTextLayout = definedExternally): `T$75`
...
external open class JavascriptUMGBlueprintLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun GetLineLength(TargetTextLayout: JavascriptTextLayout): Number
        fun GetAsText(TextLayout: JavascriptTextLayout): String
        fun DrawSpaceSpline(Context: PaintContext = definedExternally, InStart: Vector2D = definedExternally, InStartDir: Vector2D = definedExternally, InEnd: Vector2D = definedExternally, InEndDir: Vector2D = definedExternally, InThickness: Number = definedExternally, InTint: LinearColor = definedExternally): `T$76`
        fun ClearLines(TextLayout: JavascriptTextLayout = definedExternally): `T$75`
        fun AddLine(TextLayout: JavascriptTextLayout = definedExternally, Model: JavascriptTextModel = definedExternally, Runs: Array<JavascriptSlateTextRun> = definedExternally): `T$75`
...
external open class JavascriptWindow : ContentWidget {
    ...
    open fun OpenDirectoryDialog(DialogTitle: String, DefaultPath: String, OutFolderName: String = definedExternally): `T$77`
    open fun OpenFileDialog(DialogTitle: String, DefaultPath: String, DefaultFile: String, FileTypes: String, Flags: Number, OutFilenames: Array<String> = definedExternally): `T$78`
    ...
    companion object {
        ...
        fun OpenDirectoryDialog(WindowHandle: JavascriptWindow, DialogTitle: String, DefaultPath: String, OutFolderName: String = definedExternally): `T$77`
        fun OpenFileDialog(WindowHandle: JavascriptWindow, DialogTitle: String, DefaultPath: String, DefaultFile: String, FileTypes: String, Flags: Number, OutFilenames: Array<String> = definedExternally): `T$79`
    }
}
...
external open class ConstantQNRT : AudioSynesthesiaNRT {
    ...
    open fun GetNormalizedChannelConstantQAtTime(InSeconds: Number, InChannel: Number, OutConstantQ: Array<Number> = definedExternally): `T$80`
    open fun GetChannelConstantQAtTime(InSeconds: Number, InChannel: Number, OutConstantQ: Array<Number> = definedExternally): `T$81`
...
external open class LoudnessNRT : AudioSynesthesiaNRT {
    ...
    open fun GetNormalizedLoudnessAtTime(InSeconds: Number, OutLoudness: Number = definedExternally): `T$82`
    open fun GetNormalizedChannelLoudnessAtTime(InSeconds: Number, InChannel: Number, OutLoudness: Number = definedExternally): `T$82`
    open fun GetLoudnessAtTime(InSeconds: Number, OutLoudness: Number = definedExternally): `T$82`
    open fun GetChannelLoudnessAtTime(InSeconds: Number, InChannel: Number, OutLoudness: Number = definedExternally): `T$82`
...
external open class OnsetNRT : AudioSynesthesiaNRT {
    ...
    open fun GetNormalizedChannelOnsetsBetweenTimes(InStartSeconds: Number, InEndSeconds: Number, InChannel: Number, OutOnsetTimestamps: Array<Number> = definedExternally, OutOnsetStrengths: Array<Number> = definedExternally): `T$83`
    open fun GetChannelOnsetsBetweenTimes(InStartSeconds: Number, InEndSeconds: Number, InChannel: Number, OutOnsetTimestamps: Array<Number> = definedExternally, OutOnsetStrengths: Array<Number> = definedExternally): `T$84`
...
external open class KotlinObject : UObject {
    ...
    open fun EndOverlap(Other: Actor): String
...
external open class KotlinComponent : ActorComponent {
    ...
    open fun EndOverlap(Other: Actor)
    open fun BeginOverlap(Other: Actor): String
...
external open class FieldSystemComponent : PrimitiveComponent {
    ...
    open fun RemoveConstructionFields()
    open fun FalloffUniformForce(Enabled: Boolean, Position: Vector, Direction: Vector, Radius: Number, Magnitude: Number)
    open fun ApplyExternalStrain(Enabled: Boolean, Position: Vector, Radius: Number, Magnitude: Number, Iterations: Number)
    open fun SetDynamicState(Enabled: Boolean, Position: Vector, Radius: Number)
    open fun FalloffRadialForce(Enabled: Boolean, Position: Vector, Radius: Number, Magnitude: Number)
    open fun ApplyRadialForce(Enabled: Boolean, Position: Vector, Magnitude: Number)
    open fun AddTransientField(Enabled: Boolean, Target: String /* "Field_None" | "Field_DynamicState" | "Field_LinearForce" | "Field_ExternalClusterStrain" | "Field_Kill" | "Field_LinearVelocity" | "Field_AngularVelociy" | "Field_AngularTorque" | "Field_InternalClusterStrain" | "Field_DisableThreshold" | "Field_SleepingThreshold" | "Field_PositionStatic" | "Field_PositionAnimated" | "Field_PositionTarget" | "Field_DynamicConstraint" | "Field_CollisionGroup" | "Field_ActivateDisabled" | "Field_PhysicsType_Max" */, MetaData: FieldSystemMetaData, Field: FieldNodeBase)
    open fun ApplyUniformForce(Enabled: Boolean, Direction: Vector, Magnitude: Number)
    open fun AddConstructionField(Enabled: Boolean, Target: String /* "Field_None" | "Field_DynamicState" | "Field_LinearForce" | "Field_ExternalClusterStrain" | "Field_Kill" | "Field_LinearVelocity" | "Field_AngularVelociy" | "Field_AngularTorque" | "Field_InternalClusterStrain" | "Field_DisableThreshold" | "Field_SleepingThreshold" | "Field_PositionStatic" | "Field_PositionAnimated" | "Field_PositionTarget" | "Field_DynamicConstraint" | "Field_CollisionGroup" | "Field_ActivateDisabled" | "Field_PhysicsType_Max" */, MetaData: FieldSystemMetaData, Field: FieldNodeBase)
...
external open class FieldSystemMetaDataProcessingResolution : FieldSystemMetaData {
    ...
    open fun SetMetaDataResolution(ResolutionType: String /* "Field_Resolution_Minimal" | "Field_Resolution_DisabledParents" | "Field_Resolution_Maximum" | "Field_Resolution_Max" */): FieldSystemMetaDataProcessingResolution
...
external open class RadialIntMask : FieldNodeInt {
    ...
    open fun SetRadialMask(Radius: Number, Position: Vector, InteriorValue: Number, ExteriorValue: Number, SetMaskConditionIn: String /* "Field_Set_Always" | "Field_Set_IFF_NOT_Interior" | "Field_Set_IFF_NOT_Exterior" | "Field_MaskCondition_Max" */): RadialIntMask
...
external open class ReturnResultsTerminal : FieldNodeBase {
    constructor()
    constructor(Outer: UObject)
    open fun SetTerminalField(): ReturnResultsTerminal
...
external open class GeometryCollectionComponent : MeshComponent {
    ...
    open fun AddPhysicsField(Enabled: Boolean, Target: String /* "Chaos_AngularVelocity" | "Chaos_DynamicState" | "Chaos_LinearVelocity" | "Chaos_InitialAngularVelocity" | "Chaos_InitialLinearVelocity" | "Chaos_CollisionGroup" | "Chaos_LinearForce" | "Chaos_AngularTorque" | "Chaos_Max" */, MetaData: FieldSystemMetaData, Field: FieldNodeBase)
    open fun SetDynamicState(Radius: Number, Position: Vector)
...
external open class GeometryCollectionActor(InWorld: World, Location: Vector = definedExternally, Rotation: Rotator = definedExternally) : Actor {
    ...
    open fun RaycastSingle(Start: Vector, End: Vector, OutHit: HitResult = definedExternally): `T$85`
...
external open class ChaosDestructionListener : SceneComponent {
    ...
    open fun SortTrailingEvents(TrailingEvents: Array<ChaosTrailingEventData> = definedExternally, SortMethod: String /* "SortNone" | "SortByHighestMass" | "SortByHighestSpeed" | "SortByNearestFirst" | "Count" | "EChaosTrailingSortMethod_MAX" */ = definedExternally): `T$86`
    open fun SortCollisionEvents(CollisionEvents: Array<ChaosCollisionEventData> = definedExternally, SortMethod: String /* "SortNone" | "SortByHighestMass" | "SortByHighestSpeed" | "SortByHighestImpulse" | "SortByNearestFirst" | "Count" | "EChaosCollisionSortMethod_MAX" */ = definedExternally): `T$87`
    open fun SortBreakingEvents(BreakingEvents: Array<ChaosBreakingEventData> = definedExternally, SortMethod: String /* "SortNone" | "SortByHighestMass" | "SortByHighestSpeed" | "SortByNearestFirst" | "Count" | "EChaosBreakingSortMethod_MAX" */ = definedExternally): `T$88`
...
external open class SynthComponentMoto : SynthComponent {
    ...
    open var RPM: Number
    open fun SetDynamicSettings(InSettings: MotoSynthRuntimeSettings)
    open fun SetRPM(InRPM: Number, InTimeSec: Number)
    open fun IsEnabled(): Boolean
    open fun GetRPMRange(OutMinRPM: Number = definedExternally, OutMaxRPM: Number = definedExternally): `T$89`
...
external open class MagicLeapSharedWorldGameMode(InWorld: World, Location: Vector = definedExternally, Rotation: Rotator = definedExternally) : GameMode {
    ...
    open fun DetermineSharedWorldData(NewSharedWorldData: MagicLeapSharedWorldSharedData = definedExternally): `T$90`
...
external open class ImgMediaSource : BaseMediaSource {
    ...
    open fun GetProxies(OutProxies: Array<String> = definedExternally): `T$91`
...
external open class TemplateSequencePlayer : MovieSceneSequencePlayer {
    ...
    companion object {
        ...
        fun CreateTemplateSequencePlayer(WorldContextObject: UObject, TemplateSequence: TemplateSequence, Settings: MovieSceneSequencePlaybackSettings, OutActor: TemplateSequenceActor = definedExternally): `T$92`
...
external open class AudioCapture : AudioGenerator {
    ...
    open fun GetAudioCaptureDeviceInfo(OutInfo: AudioCaptureDeviceInfo = definedExternally): `T$93`
...
external open class CableComponent : MeshComponent {
    ...
    open fun GetCableParticleLocations(Locations: Array<Vector> = definedExternally): `T$94`
...
external open class EditableMesh : UObject {
    ...
    open fun WeldVertices(VertexIDs: Array<VertexID>, OutNewVertexID: VertexID = definedExternally): `T$95`
    open fun TryToRemoveVertex(VertexID: VertexID, bOutWasVertexRemoved: Boolean = definedExternally, OutNewEdgeID: EdgeID = definedExternally): `T$96`
    open fun TryToRemovePolygonEdge(EdgeID: EdgeID, bOutWasEdgeRemoved: Boolean = definedExternally, OutNewPolygonID: PolygonID = definedExternally): `T$97`
    open fun TriangulatePolygons(PolygonIDs: Array<PolygonID>, OutNewTrianglePolygons: Array<PolygonID> = definedExternally): `T$98`
    open fun TessellatePolygons(PolygonIDs: Array<PolygonID>, TriangleTessellationMode: String /* "ThreeTriangles" | "FourTriangles" | "ETriangleTessellationMode_MAX" */, OutNewPolygonIDs: Array<PolygonID> = definedExternally): `T$99`
    ...
    open fun SplitPolygons(PolygonsToSplit: Array<PolygonToSplit>, OutNewEdgeIDs: Array<EdgeID> = definedExternally): `T$100`
    open fun SplitPolygonalMesh(InPlane: Plane, PolygonIDs1: Array<PolygonID> = definedExternally, PolygonIDs2: Array<PolygonID> = definedExternally, BoundaryIDs: Array<EdgeID> = definedExternally): `T$101`
    open fun SplitEdge(EdgeID: EdgeID, Splits: Array<Number>, OutNewVertexIDs: Array<VertexID> = definedExternally): `T$102`
    ...
    open fun SearchSpatialDatabaseForPolygonsPotentiallyIntersectingPlane(InPlane: Plane, OutPolygons: Array<PolygonID> = definedExternally): `T$103`
    open fun SearchSpatialDatabaseForPolygonsPotentiallyIntersectingLineSegment(LineSegmentStart: Vector, LineSegmentEnd: Vector, OutPolygons: Array<PolygonID> = definedExternally): `T$104`
    open fun SearchSpatialDatabaseForPolygonsInVolume(planes: Array<Plane>, OutPolygons: Array<PolygonID> = definedExternally): `T$105`
    open fun RevertInstance(): EditableMesh
    open fun Revert()
    open fun RebuildRenderMesh()
    open fun QuadrangulateMesh(OutNewPolygonIDs: Array<PolygonID> = definedExternally): `T$106`
    ...
    open fun InsetPolygons(PolygonIDs: Array<PolygonID>, InsetFixedDistance: Number, InsetProgressTowardCenter: Number, Mode: String /* "All" | "CenterPolygonOnly" | "SidePolygonsOnly" | "EInsetPolygonsMode_MAX" */, OutNewCenterPolygonIDs: Array<PolygonID> = definedExternally, OutNewSidePolygonIDs: Array<PolygonID> = definedExternally): `T$107`
    open fun InsertEdgeLoop(EdgeID: EdgeID, Splits: Array<Number>, OutNewEdgeIDs: Array<EdgeID> = definedExternally): `T$108`
    open fun InitializeAdapters()
    open fun GetVertexPairEdge(VertexID: VertexID, NextVertexID: VertexID, bOutEdgeWindingIsReversed: Boolean = definedExternally): `T$109`
    open fun GetVertexInstanceVertex(VertexInstanceID: VertexInstanceID): VertexID
    open fun GetVertexInstanceCount(): Number
    open fun GetVertexInstanceConnectedPolygons(VertexInstanceID: VertexInstanceID, OutConnectedPolygonIDs: Array<PolygonID> = definedExternally): `T$110`
    ...
    open fun GetVertexConnectedPolygons(VertexID: VertexID, OutConnectedPolygonIDs: Array<PolygonID> = definedExternally): `T$111`
    open fun GetVertexConnectedEdges(VertexID: VertexID, OutConnectedEdgeIDs: Array<EdgeID> = definedExternally): `T$112`
    ...
    open fun GetVertexAdjacentVertices(VertexID: VertexID, OutAdjacentVertexIDs: Array<VertexID> = definedExternally): `T$113`
    ...
    open fun GetPolygonPerimeterVertices(PolygonID: PolygonID, OutPolygonPerimeterVertexIDs: Array<VertexID> = definedExternally): `T$114`
    open fun GetPolygonPerimeterVertexInstances(PolygonID: PolygonID, OutPolygonPerimeterVertexInstanceIDs: Array<VertexInstanceID> = definedExternally): `T$115`
    ...
    open fun GetPolygonPerimeterEdges(PolygonID: PolygonID, OutPolygonPerimeterEdgeIDs: Array<EdgeID> = definedExternally): `T$116`
    open fun GetPolygonPerimeterEdgeCount(PolygonID: PolygonID): Number
    open fun GetPolygonPerimeterEdge(PolygonID: PolygonID, PerimeterEdgeNumber: Number, bOutEdgeWindingIsReversedForPolygon: Boolean = definedExternally): `T$117`
    ...
    open fun GetPolygonAdjacentPolygons(PolygonID: PolygonID, OutAdjacentPolygons: Array<PolygonID> = definedExternally): `T$118`
    open fun GetGroupForPolygon(PolygonID: PolygonID): PolygonGroupID
    open fun GetFirstValidPolygonGroup(): PolygonGroupID
    open fun GetEdgeVertices(EdgeID: EdgeID, OutEdgeVertexID0: VertexID = definedExternally, OutEdgeVertexID1: VertexID = definedExternally): `T$119`
    ...
    open fun GetEdgeLoopElements(EdgeID: EdgeID, EdgeLoopIDs: Array<EdgeID> = definedExternally): `T$120`
    open fun GetEdgeCount(): Number
    open fun GetEdgeConnectedPolygons(EdgeID: EdgeID, OutConnectedPolygonIDs: Array<PolygonID> = definedExternally): `T$121`
    ...
    open fun FindPolygonLoop(EdgeID: EdgeID, OutEdgeLoopEdgeIDs: Array<EdgeID> = definedExternally, OutFlippedEdgeIDs: Array<EdgeID> = definedExternally, OutReversedEdgeIDPathToTake: Array<EdgeID> = definedExternally, OutPolygonIDsToSplit: Array<PolygonID> = definedExternally): `T$122`
    open fun ExtrudePolygons(Polygons: Array<PolygonID>, ExtrudeDistance: Number, bKeepNeighborsTogether: Boolean, OutNewExtrudedFrontPolygons: Array<PolygonID> = definedExternally): `T$123`
    open fun ExtendVertices(VertexIDs: Array<VertexID>, bOnlyExtendClosestEdge: Boolean, ReferencePosition: Vector, OutNewExtendedVertexIDs: Array<VertexID> = definedExternally): `T$124`
    open fun ExtendEdges(EdgeIDs: Array<EdgeID>, bWeldNeighbors: Boolean, OutNewExtendedEdgeIDs: Array<EdgeID> = definedExternally): `T$125`
    ...
    open fun CreateVertices(VerticesToCreate: Array<VertexToCreate>, OutNewVertexIDs: Array<VertexID> = definedExternally): `T$126`
    open fun CreateVertexInstances(VertexInstancesToCreate: Array<VertexInstanceToCreate>, OutNewVertexInstanceIDs: Array<VertexInstanceID> = definedExternally): `T$127`
    open fun CreatePolygons(PolygonsToCreate: Array<PolygonToCreate>, OutNewPolygonIDs: Array<PolygonID> = definedExternally, OutNewEdgeIDs: Array<EdgeID> = definedExternally): `T$128`
    open fun CreatePolygonGroups(PolygonGroupsToCreate: Array<PolygonGroupToCreate>, OutNewPolygonGroupIDs: Array<PolygonGroupID> = definedExternally): `T$129`
    open fun CreateMissingPolygonPerimeterEdges(PolygonID: PolygonID, OutNewEdgeIDs: Array<EdgeID> = definedExternally): `T$130`
    open fun CreateEmptyVertexRange(NumVerticesToCreate: Number, OutNewVertexIDs: Array<VertexID> = definedExternally): `T$131`
    open fun CreateEdges(EdgesToCreate: Array<EdgeToCreate>, OutNewEdgeIDs: Array<EdgeID> = definedExternally): `T$132`
    open fun ComputePolygonsSharedEdges(PolygonIDs: Array<PolygonID>, OutSharedEdgeIDs: Array<EdgeID> = definedExternally): `T$133`
    ...
    open fun BevelPolygons(PolygonIDs: Array<PolygonID>, BevelFixedDistance: Number, BevelProgressTowardCenter: Number, OutNewCenterPolygonIDs: Array<PolygonID> = definedExternally, OutNewSidePolygonIDs: Array<PolygonID> = definedExternally): `T$134`
...
external open class GooglePADFunctionLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun GetCellularDataConfirmationStatus(Status: String /* "AssetPack_CONFIRM_UNKNOWN" | "AssetPack_CONFIRM_PENDING" | "AssetPack_CONFIRM_USER_APPROVED" | "AssetPack_CONFIRM_USER_CANCELED" | "AssetPack_CONFIRM_MAX" */ = definedExternally): `T$135`
        ...
        fun GetDownloadState(Name: String, State: Number = definedExternally): `T$136`
        fun GetBytesDownloaded(State: Number): Number
        fun GetAssetsPath(Location: Number): String
        fun GetAssetPackLocation(Name: String, Location: Number = definedExternally): `T$137`
...
external open class SubmixEffectTapDelayPreset : SoundEffectSubmixPreset {
    ...
    open fun GetTapIds(TapIds: Array<Number> = definedExternally): `T$138`
    open fun GetTap(TapId: Number, TapInfo: TapDelayInfo = definedExternally): `T$139`
    open fun GetMaxDelayInMilliseconds(): Number
    open fun AddTap(TapId: Number = definedExternally): `T$140`
...
external open class JavascriptEditorEngineLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun GetSurfaces(Brush: Brush, Surfaces: Array<Number> = definedExternally): `T$141`
        ...
        fun Exec(Engine: EditorEngine, InWorld: World, Command: String, Out: String = definedExternally): `T$142`
...
external open class JavascriptAssetData {
    ...
    open fun GetAllTags(OutArray: Array<String> = definedExternally): `T$143`
    open fun GetNiagaraSystemAsset(): UObject
    open fun GetClass(): UnrealEngineClass
    open fun GetPackage(): Package
    open fun GetTagValue(Name: String, OutValue: String = definedExternally): `T$144`
    open fun IsAssetLoaded(): Boolean

    companion object {
        fun C(Other: UObject): JavascriptAssetData
        fun C(Other: Any): JavascriptAssetData
        fun GetAllTags(AssetData: JavascriptAssetData, OutArray: Array<String> = definedExternally): `T$145`
        ...
        fun GetTagValue(AssetData: JavascriptAssetData, Name: String, OutValue: String = definedExternally): `T$144`
...
external open class JavascriptMenuBuilder {
    ...
    open fun AddComboButton(UObject: JavascriptComboButtonContext = definedExternally, EditingObject: UObject = definedExternally): `T$146`
    open fun AddMenuByCommands(UICommands: JavascriptUICommands = definedExternally): `T$146`
    open fun AddMenuEntry(UObject: JavascriptMenuContext = definedExternally): `T$146`
    open fun AddPullDownMenu(InMenuLabel: String = definedExternally, InToolTip: String = definedExternally, InPullDownMenu: JavascriptFunction = definedExternally, InExtensionHook: String = definedExternally, InTutorialHighlightName: String = definedExternally): `T$147`
    open fun AddSeparator(): `T$146`
    open fun AddSubMenu(Label: String = definedExternally, Tooltip: String = definedExternally, bInOpenSubMenuOnClick: Boolean = definedExternally, UFunction: JavascriptFunction = definedExternally): `T$146`
    open fun AddToolBarButton(CommandInfo: JavascriptUICommandInfo = definedExternally): `T$146`
    open fun AddToolBarButtonByContext(Context: JavascriptToolbarButtonContext = definedExternally, EditingObject: UObject = definedExternally): `T$146`
    open fun AddWidget(Widget: Widget = definedExternally, Label: String = definedExternally, bNoIndent: Boolean = definedExternally, InTutorialHighlightName: String = definedExternally, bSearchable: Boolean = definedExternally): `T$146`
    open fun BeginSection(InExtensionHook: String = definedExternally, MenuHeadingText: String = definedExternally): `T$146`
    open fun EndSection(): `T$146`
    open fun PopCommandList(): `T$146`
    open fun PushCommandList(List: JavascriptUICommandList = definedExternally): `T$146`

    companion object {
        fun C(Other: UObject): JavascriptMenuBuilder
        fun C(Other: Any): JavascriptMenuBuilder
        fun AddComboButton(Builder: JavascriptMenuBuilder = definedExternally, UObject: JavascriptComboButtonContext = definedExternally, EditingObject: UObject = definedExternally): `T$146`
        fun AddMenuByCommands(Builder: JavascriptMenuBuilder = definedExternally, UICommands: JavascriptUICommands = definedExternally): `T$146`
        fun AddMenuEntry(Builder: JavascriptMenuBuilder = definedExternally, UObject: JavascriptMenuContext = definedExternally): `T$146`
        fun AddPullDownMenu(MenuBuilder: JavascriptMenuBuilder = definedExternally, InMenuLabel: String = definedExternally, InToolTip: String = definedExternally, InPullDownMenu: JavascriptFunction = definedExternally, InExtensionHook: String = definedExternally, InTutorialHighlightName: String = definedExternally): `T$147`
        fun AddSeparator(Builder: JavascriptMenuBuilder = definedExternally): `T$146`
        fun AddSubMenu(Builder: JavascriptMenuBuilder = definedExternally, Label: String = definedExternally, Tooltip: String = definedExternally, bInOpenSubMenuOnClick: Boolean = definedExternally, UFunction: JavascriptFunction = definedExternally): `T$146`
        fun AddToolBarButton(Builder: JavascriptMenuBuilder = definedExternally, CommandInfo: JavascriptUICommandInfo = definedExternally): `T$146`
        fun AddToolBarButtonByContext(Builder: JavascriptMenuBuilder = definedExternally, Context: JavascriptToolbarButtonContext = definedExternally, EditingObject: UObject = definedExternally): `T$146`
        fun AddWidget(Builder: JavascriptMenuBuilder = definedExternally, Widget: Widget = definedExternally, Label: String = definedExternally, bNoIndent: Boolean = definedExternally, InTutorialHighlightName: String = definedExternally, bSearchable: Boolean = definedExternally): `T$146`
        fun BeginSection(Builder: JavascriptMenuBuilder = definedExternally, InExtensionHook: String = definedExternally, MenuHeadingText: String = definedExternally): `T$146`
        fun EndSection(Builder: JavascriptMenuBuilder = definedExternally): `T$146`
        fun PopCommandList(Builder: JavascriptMenuBuilder = definedExternally): `T$146`
        fun PushCommandList(Builder: JavascriptMenuBuilder = definedExternally, List: JavascriptUICommandList = definedExternally): `T$146`
    }
}
...
external open class JavascriptExtender {
    ...
    open fun Apply(ExtensionHook: String, HookPosition: String /* "Before" | "After" | "First" | "EJavascriptExtensionHook_MAX" */, MenuBuilder: JavascriptMenuBuilder = definedExternally): `T$147`
    ...
    companion object {
        ...
        fun Apply(Extender: JavascriptExtender, ExtensionHook: String, HookPosition: String /* "Before" | "After" | "First" | "EJavascriptExtensionHook_MAX" */, MenuBuilder: JavascriptMenuBuilder = definedExternally): `T$147`
...
external open class JavascriptPDI {
    ...
    open fun DrawWireCone(Verts: Array<Vector> = definedExternally, Transform: Transform = definedExternally, ConeRadius: Number = definedExternally, ConeAngle: Number = definedExternally, ConeSides: Number = definedExternally, Color: LinearColor = definedExternally, DepthPriority: String /* "SDPG_World" | "SDPG_Foreground" | "SDPG_MAX" */ = definedExternally, Thickness: Number = definedExternally, DepthBias: Number = definedExternally, bScreenSpace: Boolean = definedExternally): `T$148`
    ...
    companion object {
        ...
        fun DrawWireCone(PDI: JavascriptPDI, Verts: Array<Vector> = definedExternally, Transform: Transform = definedExternally, ConeRadius: Number = definedExternally, ConeAngle: Number = definedExternally, ConeSides: Number = definedExternally, Color: LinearColor = definedExternally, DepthPriority: String /* "SDPG_World" | "SDPG_Foreground" | "SDPG_MAX" */ = definedExternally, Thickness: Number = definedExternally, DepthBias: Number = definedExternally, bScreenSpace: Boolean = definedExternally): `T$149`
...
external open class JavascriptEditorLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun SetActorLocation(Actor: Actor, NewLocation: Vector, bSweep: Boolean, SweepHitResult: HitResult = definedExternally, bTeleport: Boolean = definedExternally): `T$150`
        ...
        fun OpenFileDialog(WindowHandle: JavascriptWindow, DialogTitle: String, DefaultPath: String, DefaultFile: String, FileTypes: String, Flags: Number, OutFilenames: Array<String> = definedExternally): `T$151`
        ...
        fun LoadFileToString(Path: String, Data: String = definedExternally): `T$152`
        fun LoadFileToIntArray(Path: String, FileData: Array<Number> = definedExternally): `T$153`
        fun IsShiftDown(Click: JavascriptViewportClick): Boolean
        fun IsControlDown(Click: JavascriptViewportClick): Boolean
        fun IsAssetLoaded(AssetData: JavascriptAssetData): Boolean
        fun IsAltDown(Click: JavascriptViewportClick): Boolean
        ...
        fun GetTagValue(AssetData: JavascriptAssetData, Name: String, OutValue: String = definedExternally): `T$144`
        fun GetSelectedObjects(USelection: USelection, Out: Array<UObject> = definedExternally): `T$154`
        fun GetRootWindow(): JavascriptSlateWidget
        ...
        fun GetLandscapeExtent(LandscapeInfo: LandscapeInfo, MinX: Number = definedExternally, MinY: Number = definedExternally, MaxX: Number = definedExternally, MaxY: Number = definedExternally): `T$155`
        ...
        fun GetAllTags(AssetData: JavascriptAssetData, OutArray: Array<String> = definedExternally): `T$156`
        ...
        fun DrawWireDiamond(PDI: JavascriptPDI, Transform: Transform, Size: Number, InColor: LinearColor, DepthPriority: String /* "SDPG_World" | "SDPG_Foreground" | "SDPG_MAX" */)
        fun DrawWireCylinder(PDI: JavascriptPDI, Base: Vector, X: Vector, Y: Vector, Z: Vector, Color: LinearColor, Radius: Number, HalfHeight: Number, NumSides: Number, DepthPriority: String /* "SDPG_World" | "SDPG_Foreground" | "SDPG_MAX" */, Thickness: Number, DepthBias: Number, bScreenSpace: Boolean)
        fun DrawWireCone(PDI: JavascriptPDI, Verts: Array<Vector> = definedExternally, Transform: Transform = definedExternally, ConeRadius: Number = definedExternally, ConeAngle: Number = definedExternally, ConeSides: Number = definedExternally, Color: LinearColor = definedExternally, DepthPriority: String /* "SDPG_World" | "SDPG_Foreground" | "SDPG_MAX" */ = definedExternally, Thickness: Number = definedExternally, DepthBias: Number = definedExternally, bScreenSpace: Boolean = definedExternally): `T$157`
        fun DrawWireChoppedCone(PDI: JavascriptPDI, Base: Vector, X: Vector, Y: Vector, Z: Vector, Color: LinearColor, Radius: Number, TopRadius: Number, HalfHeight: Number, NumSides: Number, DepthPriority: String /* "SDPG_World" | "SDPG_Foreground" | "SDPG_MAX" */)
        fun DrawWireCapsule(PDI: JavascriptPDI, Base: Vector, X: Vector, Y: Vector, Z: Vector, Color: LinearColor, Radius: Number, HalfHeight: Number, NumSides: Number, DepthPriority: String /* "SDPG_World" | "SDPG_Foreground" | "SDPG_MAX" */, Thickness: Number, DepthBias: Number, bScreenSpace: Boolean)
        fun DrawWireBox2(PDI: JavascriptPDI, Matrix: Transform, Box: Box, Color: LinearColor, DepthPriority: String /* "SDPG_World" | "SDPG_Foreground" | "SDPG_MAX" */, Thickness: Number, DepthBias: Number, bScreenSpace: Boolean)
        fun DrawWireBox(PDI: JavascriptPDI, Box: Box, Color: LinearColor, DepthPriority: String /* "SDPG_World" | "SDPG_Foreground" | "SDPG_MAX" */, Thickness: Number, DepthBias: Number, bScreenSpace: Boolean)
...
external open class JavascriptEditorViewport : PanelWidget {
    ...
    open fun Redraw()
    open fun ProjectWorldToScreen(WorldPosition: Vector, OutScreenPosition: Vector2D = definedExternally): `T$158`
    ...
    open fun DeprojectScreenToWorld(ScreenPosition: Vector2D, OutRayOrigin: Vector = definedExternally, OutRayDirection: Vector = definedExternally): `T$159`
...
external open class JavascriptEditorModeTools {
    ...
    open fun ActivateDefaultMode(): `T$160`
    open fun ActivateMode(InID: String = definedExternally, bToggle: Boolean = definedExternally): `T$160`
    open fun DeactivateAllModes(): `T$160`
    open fun DeactivateMode(InID: String = definedExternally): `T$160`
    open fun DestroyMode(InID: String = definedExternally): `T$160`
    open fun EndTracking(Viewport: JavascriptEdViewport): Boolean
    open fun EnsureNotInMode(ModeId: String = definedExternally, ErrorMsg: String = definedExternally, bNotifyUser: Boolean = definedExternally): `T$161`
    open fun IsDefaultModeActive(): `T$161`
    open fun IsModeActive(InID: String = definedExternally): `T$161`
    open fun IsTracking(): Boolean
    open fun SetDefaultMode(DefaultID: String = definedExternally): `T$160`
    ...
    companion object {
        ...
        fun ActivateDefaultMode(Tools: JavascriptEditorModeTools = definedExternally): `T$160`
        fun ActivateMode(Tools: JavascriptEditorModeTools = definedExternally, InID: String = definedExternally, bToggle: Boolean = definedExternally): `T$160`
        fun DeactivateAllModes(Tools: JavascriptEditorModeTools = definedExternally): `T$160`
        fun DeactivateMode(Tools: JavascriptEditorModeTools = definedExternally, InID: String = definedExternally): `T$160`
        fun DestroyMode(Tools: JavascriptEditorModeTools = definedExternally, InID: String = definedExternally): `T$160`
        fun EndTracking(Tools: JavascriptEditorModeTools, Viewport: JavascriptEdViewport): Boolean
        fun EnsureNotInMode(Tools: JavascriptEditorModeTools = definedExternally, ModeId: String = definedExternally, ErrorMsg: String = definedExternally, bNotifyUser: Boolean = definedExternally): `T$161`
        fun IsDefaultModeActive(Tools: JavascriptEditorModeTools = definedExternally): `T$161`
        fun IsModeActive(Tools: JavascriptEditorModeTools = definedExternally, InID: String = definedExternally): `T$161`
        fun IsTracking(Tools: JavascriptEditorModeTools): Boolean
        fun SetDefaultMode(Tools: JavascriptEditorModeTools = definedExternally, DefaultID: String = definedExternally): `T$160`
...
external open class JavascriptMultiBox : Widget {
    ...
    open fun AddSubMenu(Builder: JavascriptMenuBuilder = definedExternally, ID: String = definedExternally, Label: String = definedExternally, Tooltip: String = definedExternally, bInOpenSubMenuOnClick: Boolean = definedExternally): `T$146`
    open fun AddPullDownMenu(Builder: JavascriptMenuBuilder = definedExternally, ID: String = definedExternally, Label: String = definedExternally, Tooltip: String = definedExternally): `T$146`
...
external open class JavascriptPropertyHandle {
    ...
    open fun GetJavascriptRefValue(OutValue: JavascriptRef = definedExternally): `T$162`
    open fun GetKeyHandle(): JavascriptPropertyHandle
    open fun GetMetaData(Key: String): String
    open fun GetObjectValue(OutValue: UObject = definedExternally): `T$163`
    open fun GetOuterObjects(): Array<UObject>
    open fun GetParentHandle(): JavascriptPropertyHandle
    open fun GetProperty(): Any
    open fun GetValueAsFormattedString(OutValue: String = definedExternally): `T$164`
    ...
    companion object {
        ...
        fun GetJavascriptRefValue(Handle: JavascriptPropertyHandle, OutValue: JavascriptRef = definedExternally): `T$162`
        ...
        fun GetObjectValue(Handle: JavascriptPropertyHandle, OutValue: UObject = definedExternally): `T$163`
        ...
        fun GetValueAsFormattedString(Handle: JavascriptPropertyHandle, OutValue: String = definedExternally): `T$164`
...
external open class JavascriptDetailChildrenBuilder {
    ...
    open fun AddExternalObjectProperty(Objects: Array<UObject> = definedExternally, PropertyName: String = definedExternally, UniqueIdName: String = definedExternally, bAllowChildrenOverride: Boolean = definedExternally, bCreateCategoryNodesOverride: Boolean = definedExternally): `T$165`
    open fun AddExternalObjects(Objects: Array<UObject> = definedExternally, UniqueIdName: String = definedExternally): `T$166`
    ...
    companion object {
        ...
        fun AddExternalObjectProperty(ChildBuilder: JavascriptDetailChildrenBuilder, Objects: Array<UObject> = definedExternally, PropertyName: String = definedExternally, UniqueIdName: String = definedExternally, bAllowChildrenOverride: Boolean = definedExternally, bCreateCategoryNodesOverride: Boolean = definedExternally): `T$167`
        fun AddExternalObjects(ChildBuilder: JavascriptDetailChildrenBuilder, Objects: Array<UObject> = definedExternally, UniqueIdName: String = definedExternally): `T$168`
...
external open class JavascriptPropertyCustomizationLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun CreatePropertyNameWidget(Handle: JavascriptPropertyHandle, NameOverride: String, ToolTipOverride: String, bDisplayResetToDefault: Boolean, bHideText: Boolean, bHideThumbnail: Boolean): JavascriptSlateWidget
        fun BindVisibility(Row: JavascriptDetailPropertyRow, Wrapper: JavascriptSimpleGetBoolDelegateWrapper)
        fun AddExternalObjects(ChildBuilder: JavascriptDetailChildrenBuilder, Objects: Array<UObject> = definedExternally, UniqueIdName: String = definedExternally): `T$169`
        fun AddExternalObjectProperty(ChildBuilder: JavascriptDetailChildrenBuilder, Objects: Array<UObject> = definedExternally, PropertyName: String = definedExternally, UniqueIdName: String = definedExternally, bAllowChildrenOverride: Boolean = definedExternally, bCreateCategoryNodesOverride: Boolean = definedExternally): `T$170`
        fun AddChildProperty(ChildBuilder: JavascriptDetailChildrenBuilder, PropertyHandle: JavascriptPropertyHandle): JavascriptDetailPropertyRow
        fun AddChildContent(ChildBuilder: JavascriptDetailChildrenBuilder, SearchString: String): JavascriptDetailWidgetRow
...
external open class JavascriptRawMeshLibrary : BlueprintFunctionLibrary {
    ...
    companion object {
        ...
        fun SaveRawMesh(StaticMesh: StaticMesh, SourceModelIndex: Number, InMesh: JavascriptRawMesh = definedExternally): `T$171`
        fun LoadRawMesh(StaticMesh: StaticMesh, SourceModelIndex: Number, OutMesh: JavascriptRawMesh = definedExternally): `T$172`
        fun IsValidOrFixable(RawMesh: JavascriptRawMesh): Boolean
        fun IsValidAssetData(RawMesh: JavascriptRawMesh): Boolean
        ...
        fun Empty(RawMesh: JavascriptRawMesh = definedExternally): `T$173`
        fun CompactMaterialIndices(RawMesh: JavascriptRawMesh = definedExternally): `T$173`
...
external open class JavascriptGraphConnectionDrawingPolicyContainer {
    ...
    open fun DetermineWiringStyle(OutputPin: JavascriptEdGraphPin, InputPin: JavascriptEdGraphPin, Params: JavascriptConnectionParams = definedExternally): `T$174`
    ...
    companion object {
        ...
        fun DetermineWiringStyle(Container: JavascriptGraphConnectionDrawingPolicyContainer, OutputPin: JavascriptEdGraphPin, InputPin: JavascriptEdGraphPin, Params: JavascriptConnectionParams = definedExternally): `T$174`
...
external open class JavascriptNodeCreator {
    ...
    open fun Finalize(): `T$175`

    companion object {
        fun C(Other: UObject): JavascriptNodeCreator
        fun C(Other: Any): JavascriptNodeCreator
        fun Finalize(Creator: JavascriptNodeCreator = definedExternally): `T$175`
    }
}
...
external open class JavascriptGraphEditorWidget : Widget {
    ...
    open fun GetViewLocation(OutLocation: Vector2D = definedExternally, OutZoomAmount: Number = definedExternally): `T$176`
